...
class BeerSong {
  ...
  static verse(verseLine) {
    return new BeerSong().verse(verseLine);
  }
  ...
  verse(verseLine) {
    ...
    let secondSentance = `Take ${takeDown} down and pass it around, ${count} ${bottle} of beer on the wall.\n`;
